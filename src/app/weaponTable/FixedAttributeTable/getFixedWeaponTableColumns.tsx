...
const actionColumn: FixedAttributeTableColumnDef = {
  ...
  render(rowData, actions) {
    const { onCopyAttributes, ...otherActions } = actions;
    const handleCopyAttributes =
      onCopyAttributes && rowData.attributeMarkers
        ? () => onCopyAttributes(rowData.attributeMarkers!)
        : undefined;
    return <ActionRenderer {...otherActions} onCopyAttributes={handleCopyAttributes} />;
  },
};
